...
function getLabel(page, text) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, test_1.expect)(page.getByLabel(text, { exact: true })).toBeVisible()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function getLabelPartialMatch(page, text) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, test_1.expect)(page.getByLabel(text)).toBeVisible()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
