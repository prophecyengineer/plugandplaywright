            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    try {
                        ...
                        throw new Error("Error in testId \"".concat(testId, "\":\n Expected count: ").concat(expectedCount, ", but received:\n").concat(actualCount));
                    }
                    return [2 /*return*/];
            }
        });
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    try {
                        ...
                        throw new Error("Error in testId \"".concat(testId, "\":\n Expected count: ").concat(expectedMaximumCount, ", but received:\n").concat(actualCount));
                    }
                    return [2 /*return*/];
            }
        });
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    try {
                        ...
                        throw new Error("Error in testId \"".concat(testId, "\":\n Expected count: ").concat(expectedMinimumCount, ", but received:\n").concat(actualCount));
                    }
                    return [2 /*return*/];
            }
        });
