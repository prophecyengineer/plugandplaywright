...
function getLink(page, linkName, specificSelector) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, test_1.expect)(eval("page.getByRole(\"link\", { name: \"".concat(linkName, "\",\n exact: true })").concat(specificSelector && specificSelector))).toBeVisible()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function getLinkWithId(page, locatorId, linkName) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, test_1.expect)(page.locator("#".concat(locatorId)).getByRole("link", {
                        name: linkName,
                        exact: true,
                    })).toBeVisible()];
                case 1:
