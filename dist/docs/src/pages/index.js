...
var HomepageFeatures_1 = __importDefault(require("../components/HomepageFeatures"));
...
function Home() {
    var siteConfig = (0, useDocusaurusContext_1.default)().siteConfig;
    return (react_1.default.createElement(Layout_1.default, { title: "Hello from ".concat(siteConfig.title), description: "Description will go into a meta tag in <head />" },
