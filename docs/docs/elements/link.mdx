...
```jsx {5}
import { getLink } from 'plugandplaywright'
...
```jsx {5}
import { getLinkPartialMatch } from 'plugandplaywright'
...
```jsx {5}
import { hoverLink } from 'plugandplaywright'
...
```jsx {5}
import { clickLink } from 'plugandplaywright'
